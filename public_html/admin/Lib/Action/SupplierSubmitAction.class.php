	...
	public function update() {
...

		{
...

			{
				...
				//11.9
				$supplier_info['salesman_id'] = $data['salesman_id'];
			...
			$location_info['biz_other_license'] = $data['h_license2'];	
			$location_info['salesman_id'] = $data['salesman_id'];
			
	        $location_info['bank_info'] = $data['h_bank_info'];
            $location_info['bank_user'] = $data['h_bank_user'];
			$location_info['bank_name'] = $data['h_bank_name'];
