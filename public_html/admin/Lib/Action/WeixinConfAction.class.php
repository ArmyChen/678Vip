...
class WeixinConfAction extends CommonAction{
	public function index()
	{
		...
		$this->assign("testurl",SITE_DOMAIN.APP_ROOT."/biz.php?ctl=weixin&act=valid_url");
		$this->assign("authurl",SITE_DOMAIN.APP_ROOT."/biz.php?ctl=weixin&act=accept");
		$this->assign("gzurl",SITE_DOMAIN.APP_ROOT."/biz.php?ctl=weixin&act=gz_accept&appid=");
