...
function sedit(id)
{
	location.href = ROOT+"?"+VAR_MODULE+"="+MODULE_NAME+"&"+VAR_ACTION+"=sedit&id="+id;
}
//审核跳转
function uedit(id)
{
	location.href = ROOT+"?"+VAR_MODULE+"="+MODULE_NAME+"&"+VAR_ACTION+"=uedit&id="+id;
}
//审核跳转
function tuanview(id)
{
	location.href = ROOT+"?"+VAR_MODULE+"="+MODULE_NAME+"&"+VAR_ACTION+"=tuanview&id="+id;
}
//添加跳转
function add_goods()
{
