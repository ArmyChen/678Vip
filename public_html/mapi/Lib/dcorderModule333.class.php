...
//        output($root,0,$menu_list);
        ...
        $sql = "select * from ".DB_PREFIX."dc_cart where cart_type = 1 and session_id='".es_session::id()."'";
...
//
//            $sql = "select * from ".DB_PREFIX."dc_cart where session_id='".$menu_order['session_id']."'";
//            $cart = $GLOBALS['db']->getAll($sql);
            ...
            $menu_order['table_time_id']=$vv['table_time_id'];
            $menu_order['table_time']=$vv['table_time'];
        ...
        $sql = "select * from ".DB_PREFIX."dc_cart where cart_type = 0 and session_id='".es_session::id()."'";
        $cart = $GLOBALS['db']->getAll($sql);
