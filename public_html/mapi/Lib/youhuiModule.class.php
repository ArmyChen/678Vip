...

{
    ...
    public function detail(){
        ...
        $data['description'] = get_abs_img_root(format_html_content_image($youhui_info['description'],300));

        $data['use_notice'] = get_abs_img_root(format_html_content_image($youhui_info['use_notice'],300));
