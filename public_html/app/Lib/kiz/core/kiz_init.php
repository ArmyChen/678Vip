...
require_once APP_ROOT_PATH.'app/Lib/kiz/core/kiz_lib.php';
$IMG_APP_ROOT = APP_ROOT;
define("APP_INDEX","kiz");
...
if(!file_exists(APP_ROOT_PATH.'public/runtime/app/tpl_caches/kiz/'))
	mkdir(APP_ROOT_PATH.'public/runtime/app/tpl_caches/kiz/',0777);
if(!file_exists(APP_ROOT_PATH.'public/runtime/app/tpl_compiled/kiz/'))
	mkdir(APP_ROOT_PATH.'public/runtime/app/tpl_compiled/kiz/',0777);
$GLOBALS['tmpl']->cache_dir      = APP_ROOT_PATH . 'public/runtime/app/tpl_caches/kiz';
$GLOBALS['tmpl']->compile_dir    = APP_ROOT_PATH . 'public/runtime/app/tpl_compiled/kiz';
$GLOBALS['tmpl']->template_dir   = APP_ROOT_PATH . 'app/Tpl/kiz';

//定义模板路径
$tmpl_path = SITE_DOMAIN.APP_ROOT."/app/Tpl/";
$GLOBALS['tmpl']->assign("TMPL",$tmpl_path."kiz");
$GLOBALS['tmpl']->assign("TMPL_REAL",APP_ROOT_PATH."app/Tpl/kiz"); 
