...
class userModule extends KizBaseModule{
	...
	public function register(){
		...
		if ($step==2){
			...
			{
				app_redirect(url("kiz","user#register"));
			}
	...
	function do_login(){
		...
		if($result['status']){
			...
			es_cookie::set("account_name",$account_info['account_name'],3600*24*1);
...
// 			}
	...
	function do_register(){
		...
		$ins_data['h_license2'] = strim($post_data['h_license2']);
		$ins_data['h_license3'] = strim($post_data['h_license3']);
		$ins_data['h_other_license'] = strim($post_data['h_other_license']);
		$ins_data['h_other_license2'] = strim($post_data['h_other_license2']);
		$ins_data['h_other_license3'] = strim($post_data['h_other_license3']);
		$ins_data['h_other_license4'] = strim($post_data['h_other_license4']);
		$ins_data['h_other_license5'] = strim($post_data['h_other_license5']);
		$ins_data['h_other_license6'] = strim($post_data['h_other_license6']);
		$ins_data['h_other_license7'] = strim($post_data['h_other_license7']);
		$ins_data['h_supplier_logo'] = strim($post_data['h_supplier_logo']);
		$ins_data['h_supplier_image'] = strim($post_data['h_supplier_image']);
		$ins_data['h_supplier_image2'] = strim($post_data['h_supplier_image2']);
		$ins_data['h_supplier_image3'] = strim($post_data['h_supplier_image3']);
		$ins_data['salesman_id'] = strim($post_data['salesman_id']);
	...
	public function do_edit_password(){
        ...
        $description=array('code'=>'2002');
	    $message = array (    
 		'title' => '提示',
        'description' =>'商户密码修改，请退出后重新登陆使用！' ,
