...
require_once APP_ROOT_PATH.'app/Lib/tiz/core/tiz_lib.php';
$IMG_APP_ROOT = APP_ROOT;
define("APP_INDEX","tiz");
...
if(!file_exists(APP_ROOT_PATH.'public/runtime/app/tpl_caches/tiz/'))
	mkdir(APP_ROOT_PATH.'public/runtime/app/tpl_caches/tiz/',0777);
if(!file_exists(APP_ROOT_PATH.'public/runtime/app/tpl_compiled/tiz/'))
	mkdir(APP_ROOT_PATH.'public/runtime/app/tpl_compiled/tiz/',0777);
$GLOBALS['tmpl']->cache_dir      = APP_ROOT_PATH . 'public/runtime/app/tpl_caches/tiz';
$GLOBALS['tmpl']->compile_dir    = APP_ROOT_PATH . 'public/runtime/app/tpl_compiled/tiz';
$GLOBALS['tmpl']->template_dir   = APP_ROOT_PATH . 'app/Tpl/tiz';

//定义模板路径
$tmpl_path = SITE_DOMAIN.APP_ROOT."/app/Tpl/";
$GLOBALS['tmpl']->assign("TMPL",$tmpl_path."tiz");
$GLOBALS['tmpl']->assign("TMPL_REAL",APP_ROOT_PATH."app/Tpl/tiz"); 
