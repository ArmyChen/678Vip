...
var dc_waiter_tj = {
    ...
    opts : {
        ...
        listGridId : 'grid',
        queryUrl : '&act=dish_dc_waiter_tj_ajax',
        editUrl : '&act=dish_dc_waiter_tj_edit',
        viewUrl : '/view',
        lockUrl : '&act=dish_dc_waiter_tj_lock',
        saveUrl : '/save',
        unlockUrl : '&act=dish_dc_waiter_tj_lock',
        deleteUrl : '&act=dish_dc_waiter_tj_checkUsed',
    ...
    initQueryList : function() {
        ...
        $gridObj.dataGrid({
            ...
            colNames: ['序号','编号', '电话' , '头像','真实姓名','营销数量','营销佣金', '操作'],
            colModel: [
                ...
                {name: 'tichengmoney', index: 'tichengmoney', align: "center", width: 120},
                {
                    ...
                    width: 100,
                    formatter: function (cellvalue, options, rowObject) {
                        return "<a href='" + dishPath + "&act=dish_dc_waiter_detail&sno="+rowObject.sno+"' >查看详情</a>";
                    }
                }
            ],
            sortname: 'dpid',
