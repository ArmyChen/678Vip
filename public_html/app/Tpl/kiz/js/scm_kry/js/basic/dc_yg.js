...
var dc_yg = {
    ...
    opts : {
        ...
        listGridId : 'grid',
        queryUrl : '&act=dish_dc_yg_ajax',
        editUrl : '&act=dish_dc_yg_edit',
        viewUrl : '/view',
        lockUrl : '&act=dish_dc_yg_lock',
        saveUrl : '/save',
        unlockUrl : '&act=dish_dc_yg_lock',
        deleteUrl : '&act=dish_dc_yg_checkUsed',
    ...
    initQueryList : function() {
        ...
        $gridObj.dataGrid({
            ...
            colNames: ['序号','编号', '用户名' , '	密码','电话','真实姓名','状态'],
            colModel: [
                {name: 'sid', index: 'sid',align: "center", width: 50},
                {name: 'sno', index: 'sno',align: "center", width: 180},
                {name: 'sname', index: 'sname', align: "center", width: 250},
                {name: 'passwd', index: 'passwd', align: "center", width: 120},
