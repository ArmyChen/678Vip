...
var dc_waiter_zddetail = {
    ...
    opts : {
        ...
        listGridId : 'grid',
        queryUrl : '&act=dish_dc_waiter_zddetail_ajax&sno='+ getParam("sno"),
        editUrl : '&act=dish_dc_waiter_zddetail_edit',
        viewUrl : '/view',
        lockUrl : '&act=dish_dc_waiter_zddetail_lock',
        saveUrl : '/save',
        unlockUrl : '&act=dish_dc_waiter_zddetail_lock',
        deleteUrl : '&act=dish_dc_waiter_zddetail_checkUsed',
    ...
    initQueryList : function() {
        ...
        $gridObj.dataGrid({
            ...
            colNames: ['序号','订单号', '订单总价' , '实收金额','支付方式'],
            colModel: [
                {name: 'id', index: 'id',align: "center", width: 120},
                {name: 'onum', index: 'onum',align: "center", width: 180},
                {name: 'price', index: 'price', align: "center", width: 250},
                {name: 'money_ys', index: 'money_ys', align: "center", width: 120},
