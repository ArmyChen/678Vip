...
var hongbaoguanli = {
    ...
    opts : {
        ...
        listGridId : 'grid',
        queryUrl : '&act=dish_hongbaoguanli_ajax',
        editUrl : '&act=dish_hongbaoguanli_edit',
        viewUrl : '/view',
        lockUrl : '&act=dish_hongbaoguanli_lock',
        saveUrl : '/save',
        unlockUrl : '&act=dish_hongbaoguanli_lock',
        deleteUrl : '&act=dish_hongbaoguanli_checkUsed',
    ...
    initQueryList : function() {
        ...
        $gridObj.dataGrid({
            ...
            colNames: ['序号','用户ID', '用户名' , '发放金额','类型','被评单号','	发放时间',"备注信息"],
            colModel: [
                {name: 'id', index: 'id',align: "center", width: 50},
                {name: 'userid', index: 'userid',align: "center", width: 180},
                {name: 'user_name', index: 'user_name', align: "center", width: 250},
                {name: 'hongbaojine', index: 'hongbaojine', align: "center", width: 120},
                {name: 'typ', index: 'typ', align: "center",width: 120},
                {name: 'order_id', index: 'order_id', align: "center", width: 120},
                {name: 'sendtime', index: 'sendtime', align: "center", width: 120},
